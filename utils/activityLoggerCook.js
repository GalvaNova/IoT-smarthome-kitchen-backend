// ===============================================
// utils/activityLoggerCook.js (FINAL + FORMAT hh:mm:ss ✅)
// ===============================================
...
// ===============================
// Setup direktori log aktivitas cooking
// ===============================
const ACTIVITY_DIR = path.join(__dirname, "../logs/cook/activity");
...
// ===============================
// Fungsi utama: tulis log aktivitas cooking
// ===============================
async function writeActivityLog(startTimestamp, endTimestamp, durationSeconds) {
  ...
  const activityFile = path.join(ACTIVITY_DIR, `cook_activity_${today}.csv`);
  ...
  try {
    ...
    console.log(`Log aktivitas cooking disimpan (${durationFormatted})`);
  } catch (err) {
    console.error("❌ Gagal menulis log aktivitas cooking:", err.message);
  }
}
